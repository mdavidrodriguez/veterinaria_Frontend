...
const CambiarPassword = () => {
    ...
    const handleSubmit = async e => {
       ...
       else if(password.pwd_actual < 6){
            setAlerta({
                msg: 'El password es de minimo 6 caracteres verifique',
                error: true
            })
            return
        }
          
        else if(password.pwd_nuevo < 6){
            setAlerta({
                msg: 'El password nuevo debe de ses de minimo 6 caracteres verifique',
                error: true
            })
            return
        }
